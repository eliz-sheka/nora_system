                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.user.save') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="first_name" type="text" class="form-control" id="basic-default-fullname" value="{{ old('first_name') }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <input name="middle_name" type="text" class="form-control" id="basic-default-fullname" value="{{ old('middle_name') }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <input name="last_name" type="text" class="form-control" id="basic-default-fullname" value="{{ old('last_name') }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <input name="email" type="text" class="form-control" id="basic-default-fullname" value="{{ old('email') }}" />
                            @if ($errors->has('email'))
                            ...
                            <div class="col-md">
                                @foreach($sex as $value => $name)
                                    <div class="form-check form-check-inline mt-3">
                                        <input
                                            @if(old('sex') === $value) checked @endif
                        ...
                        <div class="mb-3">
                            ...
                            <input name="birth_date" class="form-control" type="date" id="html5-date-input" value="{{ old('birth_date') }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <select name="role" class="form-select" id="exampleFormControlSelect1" aria-label="Default select example" required>
                                ...
                                @foreach($roles as $role)
                                    <option @if(old('role') === $role->getAttribute('slug')) selected @endif value="{{ $role->getAttribute('slug') }}">{{ $role->getAttribute('name') }}</option>
                                @endforeach
                            </select>
